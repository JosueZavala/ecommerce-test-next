...
const sampleProducts: Product[] = [
  {
    ...
    description:
      "Último modelo con cámara avanzada y procesador de alta velocidad",
  },
  {
    id: 2,
    name: "Laptop Gaming",
    ...
    description:
      "Laptop para gaming con tarjeta gráfica dedicada y pantalla 144Hz",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Tablet profesional con stylus incluido y pantalla de alta resolución",
  },
  {
    id: 6,
    name: "Cámara Digital",
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {sampleProducts.map((product) => (
          <ProductCard key={`ProductCards_${product.id}`} product={product} />
        ))}
      </div>
    </div>
  );
